...
System.register("chunks:///_virtual/zn.ts",["cc"],(function(e){var t;return{setters:[function(e){t=e.cclegacy}],execute:function(){t._RF.push({},"3b7860dNwBEwLQ0cB1nU2wa","zn",void 0);var n=window,s=e("languages",{help:{title:"规则",desc1:"说明1",desc2:"在允许投注的时间内，点击投注进行下注，待投注时间结束后，火箭将起飞",next:"下一页",desc3:"说明2",desc4:"火箭在为爆炸前，你可以点击提款来取走当前的盈利。如果在爆炸前你没有提款，你将失去本轮的所有押注",close:"关闭"},game:{normal:"普通",auto:"自动",autoescape:"自动逃离",bet:"下注",betsucc:"下注成功",escape:"逃离",prebet:"预下注",noprebet:"取消预下注",mybet:"我的下注",history:"历史记录",roundid:"局号",time:"时间",bets:"下注数量",result:"结果",profit:"获得数量",startauto:"开始自动",stopauto:"停止自动",autoplay:"自动玩法",stopbywin:"stop when winning",stopbylose:"stop when losing",reset:"Reset",increase:"Increase",bywin:"By winning",bylose:"By losing",savesetting:"保存设置"},tip:{noroom:"未找到合适的房间",roomdisconnect:"与房间断开链接",dataerror:"数据异常，请退出后重新进入"}});n.languages||(n.languages={}),n.languages.zn=s,t._RF.pop()}}}));
